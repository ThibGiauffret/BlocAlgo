...
(function (root, factory) {
  ...
  Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] =
    "Les blocs repliés contiennent des avertissements.";
  ...
  Blockly.Msg["CONTROLS_FLOW_STATEMENTS_HELPURL"] =
    "https://fr.wikipedia.org/wiki/Structure_de_contrôle#Commandes_de_sortie_de_boucle";
  ...
  Blockly.Msg["CONTROLS_FOREACH_TITLE"] =
    "pour chaque élément %1 dans la liste %2";
  ...
  Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] =
    "Ajouter une condition au bloc conditionnel.";
  ...
  Blockly.Msg["CONTROLS_IF_HELPURL"] =
    "https://fr.wikipedia.org/wiki/Structure_de_contrôle#Alternatives";
  ...
  Blockly.Msg["LISTS_GET_SUBLIST_START_FROM_END"] =
    "obtenir la sous-liste depuis le n° depuis la fin";
  Blockly.Msg["LISTS_GET_SUBLIST_START_FROM_START"] =
    "obtenir la sous-liste depuis le n°";
  ...
  Blockly.Msg["LISTS_INDEX_OF_LAST"] =
    "trouver la dernière occurrence de l’élément";
  ...
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_INSERT_LAST"] =
    "Ajoute l’élément à la fin d’une liste.";
  ...
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_FIRST"] =
    "Définit le premier élément dans une liste.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_FROM"] =
    "Définit l’élément à la position indiquée dans une liste.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_LAST"] =
    "Définit le dernier élément dans une liste.";
  Blockly.Msg["LISTS_SET_INDEX_TOOLTIP_SET_RANDOM"] =
    "Définit un élément au hasard dans une liste.";
  ...
  Blockly.Msg["LISTS_SORT_TYPE_IGNORECASE"] =
    "alphabétique, en ignorant la casse";
  ...
  Blockly.Msg["LISTS_SPLIT_TOOLTIP_JOIN"] =
    "Réunir une liste de textes en un seul, en les joignant par un séparateur.";
  ...
  Blockly.Msg["LOGIC_BOOLEAN_HELPURL"] =
    "https://fr.wikipedia.org/wiki/Principe_de_bivalence";
  ...
  Blockly.Msg["LOGIC_COMPARE_HELPURL"] =
    "https://fr.wikipedia.org/wiki/In%C3%A9galit%C3%A9_(math%C3%A9matiques)";
  ...
  Blockly.Msg["LOGIC_NEGATE_HELPURL"] =
    "https://fr.wikipedia.org/wiki/Négation_logique";
  ...
  Blockly.Msg["MATH_ATAN2_TOOLTIP"] =
    "Renvoie l’arc-tangente du point (X, Y) en degrés entre -180 et 180.";
  Blockly.Msg["MATH_CHANGE_HELPURL"] =
    "https://fr.wikipedia.org/wiki/Idiome_de_programmation";
  Blockly.Msg["MATH_CHANGE_TITLE"] = "%1 += %2";
  Blockly.Msg["MATH_CHANGE_TOOLTIP"] =
    "Ajouter un nombre à la variable « %1 ».";
  ...
  Blockly.Msg["MATH_CONSTRAIN_TOOLTIP"] =
    "Contraindre un nombre à rester entre les limites spécifiées (incluses).";
  ...
  Blockly.Msg["MATH_ONLIST_HELPURL"] =
    "https://fr.wikipedia.org/wiki/Fonction_d'agrégation";
  ...
  Blockly.Msg["MATH_ONLIST_TOOLTIP_RANDOM"] =
    "Renvoyer un élément au hasard dans la liste.";
  Blockly.Msg["MATH_ONLIST_TOOLTIP_STD_DEV"] =
    "Renvoyer l’écart type de la liste.";
  ...
  Blockly.Msg["MATH_ROUND_OPERATOR_ROUNDDOWN"] =
    "arrondir par défaut (à l’entier inférieur le plus proche)";
  Blockly.Msg["MATH_ROUND_OPERATOR_ROUNDUP"] =
    "arrondir par excès (à l’entier supérieur le plus proche)";
  Blockly.Msg["MATH_ROUND_TOOLTIP"] =
    "Arrondir un nombre au-dessus ou au-dessous.";
  ...
  Blockly.Msg["MATH_SINGLE_TOOLTIP_EXP"] =
    "Renvoie e (la constante d’Euler) élevé à la puissance d’un nombre donné, c’est-à-dire l’exponentielle népérienne ou naturelle de ce nombre.";
  ...
  Blockly.Msg["PROCEDURES_CALLNORETURN_HELPURL"] =
    "https://fr.wikipedia.org/wiki/Sous-programme";
  ...
  Blockly.Msg["PROCEDURES_DEF_DUPLICATE_WARNING"] =
    "Attention : cette fonction a des paramètres en doublon.";
  Blockly.Msg["PROCEDURES_HIGHLIGHT_DEF"] =
    "Surligner la définition de la fonction";
  Blockly.Msg["PROCEDURES_IFRETURN_HELPURL"] =
    "http://c2.com/cgi/wiki?GuardClause"; // untranslated
  ...
  Blockly.Msg["PROCEDURES_MUTATORARG_TOOLTIP"] =
    "Ajouter une entrée à la fonction.";
  ...
  Blockly.Msg["RENAME_VARIABLE_TITLE"] =
    "Renommer toutes les variables « %1 » en :";
  ...
  Blockly.Msg["TEXT_CHANGECASE_OPERATOR_TITLECASE"] =
    "en Capitale Initiale Pour Chaque Mot";
  ...
  Blockly.Msg["TEXT_CHARAT_TOOLTIP"] =
    "Renvoie la lettre à la position indiquée.";
  ...
  Blockly.Msg["TEXT_COUNT_TOOLTIP"] =
    "Compter combien de fois un texte donné apparaît dans un autre.";
  ...
  Blockly.Msg["TEXT_GET_SUBSTRING_END_FROM_END"] =
    "jusqu’à la lettre nº (depuis la fin)";
  ...
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FROM_END"] =
    "obtenir la sous-chaîne depuis la lettre nº (depuis la fin)";
  Blockly.Msg["TEXT_GET_SUBSTRING_START_FROM_START"] =
    "obtenir la sous-chaîne depuis la lettre nº";
  ...
  Blockly.Msg["TEXT_JOIN_TOOLTIP"] =
    "Créer un morceau de texte en joignant bout à bout un nombre quelconque d’éléments dans l’ordre indiqué.";
  ...
  Blockly.Msg["TEXT_PRINT_TOOLTIP"] =
    "Afficher le texte, le nombre ou une autre valeur spécifiée.";
  ...
  Blockly.Msg["TEXT_REPLACE_TOOLTIP"] =
    "Remplacer toutes les occurrences d’un texte par un autre.";
  ...
  Blockly.Msg["TEXT_TRIM_OPERATOR_BOTH"] =
    "supprimer les espaces des deux côtés de";
  Blockly.Msg["TEXT_TRIM_OPERATOR_LEFT"] =
    "supprimer les espaces du côté gauche de";
  Blockly.Msg["TEXT_TRIM_OPERATOR_RIGHT"] =
    "supprimer les espaces du côté droit de";
  Blockly.Msg["TEXT_TRIM_TOOLTIP"] =
    "Renvoyer une copie du texte avec les espaces supprimés d’un ou des deux bouts.";
  ...
  Blockly.Msg["VARIABLE_ALREADY_EXISTS"] =
    "Une variable nommée « %1 » existe déjà.";
